...
import com.serdararici.travelguide.databinding.ItemChatBinding
...
class MessageAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    inner class GeminiViewHolder(private val binding: ItemChatBinding): RecyclerView.ViewHolder(binding.root) {
        fun bind(message: Pair<String,Int>){
